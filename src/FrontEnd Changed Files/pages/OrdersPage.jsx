...
import orderService from '../services/adminorders.service';
...
const OrdersPage = () => {
  ...
  useEffect(() => {
    orderService.getAllOrders().then((resp) => {
      setOrders(resp.data);
    }).then(()=>{
      console.log(orders)
    })
  ...
  const handleStatusUpdateSubmit =()=>{
    console.log("In submit ")
       orderService.updateOrderStatus(orderStat).then((resp)=>{
        alert(resp.data);
      setReRender(true)
       })
  }
                      ...
                      return (
                        <>
                          <tr>
                            ...
                            <td >{
                              order.address.adress_Line1 + " " +
                              order.address.adress_Line2
                            }</td>
