    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light py-3 sticky-top">
            ...
            { ! (user?.role===Role.ADMIN) ?
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/product"> MedEasyIn</NavLink>
                :
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/updateproduct"> MedEasyIn</NavLink> 
            }
...

                         {
                            (user?.role === Role.ADMIN) ?
                               ...
                               <span>
                                ...
                                {/* <NavLink to="/updateproduct" className="btn btn-outline-dark m-2"><i class="fa-solid fa-pen-to-square"></i> Update Product</NavLink> */}
                               </span>
